...
A z F ra ud Op s is part of the Az-Framework Summer 2.0 activity pack. It registers with Az-Summer2Core for routes, contracts, rewards, validation, and dispatch hooks.
